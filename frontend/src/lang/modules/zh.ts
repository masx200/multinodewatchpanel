...
const message = {
    ...
    monitor: {
        ...
        nodeNamePlaceholder: '如：生产服务器-01',
        nodeTagsPlaceholder: '多个标签用逗号分隔',
        apiKeyEditHint: '不修改请留空',
        selectNode: '选择节点',
        noNodeSelected: '请先选择或添加节点',
        dashboard: '监控仪表盘',
        hostList: '主机列表',
        ...
        nodeServerNamePlaceholder: '可选，覆盖 TLS SNI',
        nodeAllowInsecure: '允许不安全',
        ...
        dataRetentionDaysHint: '历史监控数据的保存天数（1–365）',
        collectInterval: '采集间隔（秒）',
        collectIntervalHint: '监控数据采集间隔，单位秒（10–43200）',
        dashboardRefresh: '仪表盘刷新（秒）',
        dashboardRefreshHint: '仪表盘自动刷新间隔，单位秒（5–300）',
    },
    terminal: {
        local: '本机',
        defaultConn: '默认连接',
